...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> userDataComplete = {};
    _cloud.getUserData().then((data) {
      print('her' + data.toString());
      userDataComplete = data;
    });
    print('yoyo');
    return Column(
